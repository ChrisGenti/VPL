package com.github.chrisgenti.vpl.velocity.data.mysql.settings;
...
public class PoolSettings {
    private final HashMap<String, String> dataSourceProperties = Maps.newHashMap();
    private final HashMap<String, String> healthCheckProperties = Maps.newHashMap();

    private String poolName = "vpl-hikari";
